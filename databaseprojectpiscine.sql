...
--
-- Host: localhost:8889
-- Generation Time: Apr 22, 2020 at 02:20 AM
...
INSERT INTO `commande` (`Id`, `Client`, `Item`) VALUES
(1, 2, 0),
(2, 2, 3),
(3, 2, 0);
...
INSERT INTO `enchere` (`Id`, `Item`, `Enchereur`, `Date`, `Prix`) VALUES
(1, 10, 2, '2020-04-22 01:11:01', 101),
(2, 1, 2, '2020-04-22 01:21:32', 500001),
(3, 2, 2, '2020-04-22 01:21:32', 2001),
(4, 8, 2, '2020-04-22 02:14:09', 400001);
...
INSERT INTO `negociation` (`Id`, `Etape`, `Proposition`, `Client`, `Vendeur`, `Prix`, `Accepete`, `Item`) VALUES
(1, 1, b'1', 2, NULL, 100, b'0', 4);
