...
<html>
	<head> 
        ...
        <!-------------------------Custom CSS-------------------------->
        <link rel="stylesheet" type="text/css" href="EceBay-Admin-Admins.css">

        <!-------------------------Custom JS--------------------------->
        <script type="text/javascript" src="JS-Admin-Admins.js"></script>
    ...
    <body>
        ...
        <div class="container">
            <br><br>
            <h1 class="text-center">Tous les Admins</h1>
            <div>
                <div class="row">
