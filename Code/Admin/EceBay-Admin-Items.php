...
<html>
    ...
    <body>
        ...
        <div class="container">
            <br><br>
            <h1 class="text-center" style="background-color: lightgrey">Liste des articles mis en ventes</h1>
            ...
            <br><br>
            <h1 class="text-center" style="background-color: lightgrey">Liste des articles vendus</h1>
